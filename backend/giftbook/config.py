...
# EMAIL
EMAIL_FROM_DEFAULT: str = env.str("GIFTBOOK_EMAIL_FROM_DEFAULT")
EMAIL_API_SEND_EMAIL_URL: str = env.str("GIFTBOOK_EMAIL_API_SEND_EMAIL_URL")
EMAIL_API_KEY: str = get_secret("GIFTBOOK_EMAIL_API_KEY")
EMAIL_TO_MAX_SIZE: int = env.int("GIFTBOOK_EMAIL_TO_MAX_SIZE", default=100)
